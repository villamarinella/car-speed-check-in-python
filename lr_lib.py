...
def fill1(frame,speed1,font,kreisrot,kreisgruen):
  ...
  color2=(0,0,255)  ## rot
  color3=(0,255,0)
  y=371       ## left gate lines
  y1=372        ##  horitontal linesposition
  y2=373        ##  take 3 lines
  x1=340    ##    vertikal line lenght starts
##############
  ...
  while True:
      ...
      frame[y2,x1] = [0,255,0]
      x1=x1+1
      if x1 >=430:         ## vertikal line finished
        break
  while True:
      frame[x2,z] = [0,0,255]
      frame[x2,z1] = [0,0,255]
  ...
  if kreisgruen: 
            cv2.circle(frame, (436,375), 20, color3, thickness=-1, lineType=8, shift=0)    
...
def init_gatel(gray):
  ...
  while True:
    ...
    #time.sleep(1)
    xl=xl+1
    if xl >=430:    ## vertikal line to control ends
       sumz=suma 
       #print suma,sumz
       break
  return(sumz)
